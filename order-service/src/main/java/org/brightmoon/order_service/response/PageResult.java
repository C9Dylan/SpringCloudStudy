 ...
 */
public class PageResult<T extends Collection<T>> extends ResultSupport {

	private static final long serialVersionUID = 9013056082881520627L;
	 ...
	 * @return
	 */
	public static <U extends Collection<U>> PageResult<U> newFailResult(int code, String message, U data) {
	 ...
	 * @return
	 */
	public static <U extends Collection<U>> PageResult<U> newFailResult(int code, String message) {
		PageResult<U> pageResult = new PageResult<U>();
		pageResult.setCode(code);
		pageResult.setMessage(message);
	...
	public static <U extends Collection<U>> PageResult<U> newSuccessResult(int pageNo, int pageSize, int totalCount,
			U data) {
